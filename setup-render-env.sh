...
echo "=========================================="
echo ""
echo "NEXT_PUBLIC_API_URL=https://oyun-uhaanii-academy-a4m9.onrender.com"
echo ""
...
echo "curl https://oyun-uhaanii-academy-a4m9.onrender.com/health"
echo ""
echo "# Test database connection"
echo "curl https://oyun-uhaanii-academy-a4m9.onrender.com/api/courses"
echo ""
