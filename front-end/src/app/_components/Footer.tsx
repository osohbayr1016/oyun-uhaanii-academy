      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="space-y-4">
            ...
            <form onSubmit={handleSubscribe} className="space-y-3">
              ...
              <button
                type="submit"
                disabled={status === "loading"}
                className="w-full px-4 py-2 bg-[#550080] cursor-pointer text-white rounded-md hover:bg-[#4d0080] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          <p className="text-gray-400 text-sm">
            © 2025 Монголын Оюун Ухааны Академи Офицер салбар
          </p>
        </div>
      </div>
    </footer>
